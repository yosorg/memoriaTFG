...
A versión 1 da cámara conta cunha resolución de 5 megapixeles mentres que a versión 2 conta con 8. \textcolor{red}{ As seguintes imaxes ilustran a diferenza de calidade de imaxe entre as dúas versión.}

\subsection{Lentes}
Para poder capturar o completo da estrada a cámara necesitará de algún tipo de lente que permita un maior campo de visión. Existen versións da cámara que xa inclúen unha lente, pero tamén poderemos atopar lentes externas coma es destinadas para os dispositivos móbiles, que contan co tamaño necesario para a cámara da Raspberry.
\textcolor{red}{Nas seguintes fotos ilustraemos as diferencias según o tipo de lente.}
...
\begin{itemize}
    ...
    Unha vez deseñado e tras comprobar que o deseño e imprimible o exportarase no formato \emph{STL} que abriremos cun software encargado de dividir o deseño en capas e traducilo a ordes de desprazamento interpretables pola impresora, como resultado obterase un arquivo \emph{GCODE}  que pasaremos a impresora. O prototipo imprimirase o prototipo en 3d probarase e aplicaranse correccións no modelo. Para este deseño realizáronse dúas iteracións móstranse na figura 3.6.
